...
<body>
    ...
    <p>
        Try publishing an event to channel <code>alert-message</code>
    ...
    <script type="text/javascript">
        ...
        var pusher = new Pusher('32863f1fe5e02e4fefea', {
            encrypted: true,
            cluster: 'ap2'
        });
        ...
        var channel = pusher.subscribe('alert-message');

        // Bind a function to a Event (the full Laravel class)
        // channel.bind('App\\Events\\MessageSent', function(data) {
        channel.bind('App\\Events\\AlertMessage', function(data) {
